...
@Tag(
        ...
        description = "CRUD REST APIs in MerYilBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside MerYilBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
